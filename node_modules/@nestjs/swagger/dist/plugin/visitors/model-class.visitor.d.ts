...
export declare class ModelClassVisitor extends AbstractFileVisitor {
    ...
    visitPropertyNodeDeclaration(node: ts.PropertyDeclaration, ctx: ts.TransformationContext, typeChecker: ts.TypeChecker, options: PluginOptions, sourceFile: ts.SourceFile, metadata: ClassMetadata, externalImports: Record<string, string>, compilerOptionsPaths: ts.MapLike<string[]>): ts.PropertyDeclaration;
    visitConstructorDeclarationNode(constructorNode: ts.ConstructorDeclaration, typeChecker: ts.TypeChecker, options: PluginOptions, sourceFile: ts.SourceFile, metadata: ClassMetadata, externalImports: Record<string, string>, compilerOptionsPaths: ts.MapLike<string[]>): void;
    ...
    inspectPropertyDeclaration(factory: ts.NodeFactory, compilerNode: ts.PropertyDeclaration, typeChecker: ts.TypeChecker, options: PluginOptions, hostFilename: string, sourceFile: ts.SourceFile, metadata: ClassMetadata, externalImports: Record<string, string>, compilerOptionsPaths: ts.MapLike<string[]>): void;
    createDecoratorObjectLiteralExpr(factory: ts.NodeFactory, node: ts.PropertyDeclaration | ts.PropertySignature | ts.ParameterDeclaration, typeChecker: ts.TypeChecker, existingProperties?: ts.NodeArray<ts.PropertyAssignment>, options?: PluginOptions, hostFilename?: string, sourceFile?: ts.SourceFile, externalImports?: Record<string, string>, compilerOptionsPaths?: ts.MapLike<string[]>): ts.ObjectLiteralExpression;
    private createTypePropertyAssignments;
    createInitializerForTypeLiteralNode(node: ts.TypeLiteralNode, factory: ts.NodeFactory, typeChecker: ts.TypeChecker, existingProperties: ts.NodeArray<ts.PropertyAssignment>, hostFilename: string, options: PluginOptions, externalImports: Record<string, string>, compilerOptionsPaths: ts.MapLike<string[]>): ts.ArrowFunction;
    isNullableUnion(node: ts.UnionTypeNode): {
        nullableType: ts.TypeNode;
        isNullable: boolean;
    };
    createEnumPropertyAssignment(factory: ts.NodeFactory, node: ts.PropertyDeclaration | ts.PropertySignature | ts.ParameterDeclaration, typeChecker: ts.TypeChecker, existingProperties: ts.NodeArray<ts.PropertyAssignment>, hostFilename: string, options: PluginOptions, externalImports: Record<string, string>, compilerOptionsPaths: ts.MapLike<string[]>): ts.PropertyAssignment | ts.PropertyAssignment[];
